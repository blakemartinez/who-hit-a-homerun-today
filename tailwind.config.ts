...
const config: Config = {
  ...
  safelist: [
    ...
    "ring-2", "ring-offset-2", "ring-offset-4", "ring-offset-zinc-900", "ring-offset-zinc-950",
    "ring-emerald-600", "ring-red-700", "ring-yellow-400", "ring-purple-500", "ring-blue-500",
    "outline", "outline-2", "outline-offset-2", "outline-offset-4",
    "outline-emerald-600", "outline-red-600", "outline-yellow-500", "outline-purple-600", "outline-blue-600",
    // Flag dot colors (nav dots + game log indicators)
    "bg-red-600", "bg-yellow-500", "bg-purple-500", "bg-blue-500",
  ],
  plugins: [],
};
